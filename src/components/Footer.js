        ...
        return (
            <footer id="colophon" className="site-footer">
                    ...
                    <div className="inner">
                        <div className="footer-widgets">
                            <div className="widget footer-branding">
                                {_.get(config, 'footer.logo_img') ?
                                    <p className="site-logo">
                                        <Link to={safePrefix('/')}><img src={_.get(config, 'footer.logo_img.file.url')} alt="Logo" /></Link>
                                    </p>
                                    :
                                ...
                                {_.get(config, 'footer.tagline.tagline') &&
                            ...
                            <nav className="widget footer-navigation">
                                <div className="footer-nav-inside">
                                    ...
                                    <div className="secondary-nav">
                                        <h2 className="widget-title">{_.get(config, 'footer.nav_title.nav_title')}</h2>
                                    ...
                                    <div className="social-nav">
                                        <h2 className="widget-title">{_.get(config, 'footer.social_title.social_title')}</h2>
                            ...
                            <div className="widget footer-subscribe">
                                <h2 className="widget-title">{_.get(config, 'footer.subscribe_title.subscribe_title')}</h2>
                                {_.get(config, 'footer.subscribe_content') &&
                                <p>{htmlToReact(_.get(config, 'footer.subscribe_content.subscribe_content'))}</p>
                                }
                ...
                <div className="site-info outer">
                    <div className="inner">
                        {htmlToReact(_.get(config, 'footer.content.content'))}
                        &nbsp;
