...
export default class SectionContact extends React.Component {
    render() {
        ...
        return (
            <section id={_.get(section, 'section_id.section_id')} className={'block contact-block bg-' + _.get(section, 'bg') + ' outer'}>
                ...
                <div className="block-content inner-medium">
                    ...
                    <form name="contactForm" method="POST" id="contact-form"
