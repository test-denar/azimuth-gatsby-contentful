...
export default class SectionFeatures extends React.Component {
    render() {
        ...
        return (
            <section id={_.get(section, 'section_id.section_id')} className={'block features-block bg-' + _.get(section, 'bg') + ' outer'}>
                        ...
                        <div key={featureIndex} className="block-item">
                            <div className="grid">
                                ...
                                <div className="cell block-preview">
                                    <img src={_.get(feature, 'image.file.url')} alt={_.get(feature, 'title.title')} />
                                </div>
                                }
