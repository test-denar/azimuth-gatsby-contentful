...
export default class SectionReviews extends React.Component {
    render() {
        ...
        return (
            <section id={_.get(section, 'section_id.section_id')} className={'block reviews-block bg-' + _.get(section, 'bg') + ' outer'}>
                            ...
                            <blockquote key={reviewIdx} className="cell review">
                                <div className="review-inside">
                                    ...
                                    <footer className="review-footer">
                                        {_.get(review, 'avatar') &&
                                        <img className="review-avatar" src={_.get(review, 'avatar.file.url')} alt="Author avatar"/>
                                        }
